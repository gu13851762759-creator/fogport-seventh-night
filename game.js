(() => {
  ...
  captureStore.onclick = () => { click(); if (captureItem) addClue(captureItem.id, captureItem.label, captureItem.type, captureItem.detail); capture.classList.add('hidden'); capture.setAttribute('aria-hidden','true'); captureItem = null; if (s.scene === 'desk') desk(); };
